...
function CultivationCard({ cultivationData }) {
  ...
  return (
    <button className="flex flex-row items-center justify-start gap-6 p-4 text-text-50 bg-background-800 hover:bg-background-800/80 transition-colors rounded-sm shadow-sm w-full max-w-3xl">
